...
QT_MOC_LITERAL(1, 9, 18), // "registerSuccessful"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 13), // "switchToLogin"
QT_MOC_LITERAL(4, 43, 10) // "onRegister"

    },
    "Register\0registerSuccessful\0\0switchToLogin\0"
    "onRegister"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::registerSuccessful)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Register::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Register::switchToLogin)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Register::registerSuccessful()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Register::switchToLogin()
{
